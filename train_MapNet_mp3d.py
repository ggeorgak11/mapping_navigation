...
if __name__ == '__main__':
    ...
    mp3d = MP3D(par, seq_len=par.seq_len, nEpisodes=par.epi_per_scene, 
    ...
    for ep in range(par.nEpochs):
        ...
        for i in range(iters_per_epoch):
            ...
            batch = get_minibatch(par, data=mp3d, ex_ids=train_ids, data_index=data_index)
            ...
            # Use a p0 (defined inside mapNet) instead of a map_0
            #start = time.time()
            ...
            if iters % par.test_interval == 0:
                evaluate_MapNet(par, test_iter=iters, test_ids=test_ids, test_data=mp3d)
